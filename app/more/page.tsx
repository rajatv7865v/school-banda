            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="text-left min-w-0">
                  <span className="block font-semibold text-gray-800">Mobile App</span>
                  <span className="block text-sm text-gray-500 mt-0.5">Download app for attendance &amp; fee management</span>
                </div>
