          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li className="flex items-start">
                ...
                >
                  Gayatri Nagar, Near Power House Banda, Shahjahanpur, Uttar Pradesh
                </a>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>Phone: +91 7897156698</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>Email: Sgmssic2012@gmail.com</span>
              </li>
            </ul>
          </div>

          {/* Mobile App QR */}
          <div className="flex flex-col items-center md:items-start lg:items-center text-center lg:text-center">
